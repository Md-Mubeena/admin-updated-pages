...
<tr>
<td align="left"><font size="5"><b>User Name </b></font></td>
<td>
<input type="text" placeholder="User name" name="uname" pattern="(u){1}[1-9][a-z0-9]{2,15}" title="Enter Username that starts with 'u' followed by one digit other than'0'" required> 
</td></tr>



<tr><td align="left"><font size="5"><b>Password </b></font></td>
<td><input type="password" placeholder="Enter Password" name="pwd" required></td></tr>



<tr><td align="left"><font size="5"><b>Roll Code </b></font></td>
<td><input type="rolecode" placeholder="Role Code" name="rolecode"  value=<%=request.getParameter("type")%> readonly></td></tr>

		
<tr><td align="left"><font size="5"><b>Account Number </b></font></td>
<td><input type="text" placeholder="Account Number" name="accountno" pattern="[1-9][0-9]{2,9}" title="Please enter valid Number" required > </td></tr>
